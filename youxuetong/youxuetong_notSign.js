const $ = new Env('油学通签到');
// Retrieve JWSESSION from storage
const JWSESSION = $.getdata('JWSESSION');


function getSignList() {
  // URL and query parameters
  const url = 'https://gwxg.xsyu.edu.cn/sign/mobile/receive/getMySignLogs';
  const params = {
    page: 1,
    size: 10
  };
...
// Function to get sign peoples
function notSignPeoples(signId) {
  // Define the URL and query parameters
  const url = 'https://gwxg.xsyu.edu.cn/sign/mobile/receive/getSignPeoples';
  const params = {
    keywords: '',
    schoolId: 17,
    signId: signId,
  ...
  const headers = {
    ...
    'Sec-Fetch-Mode': 'cors',
    'Content-Type': 'application/json;charset=UTF-8',
    'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.43(0x18002b2d) NetType/WIFI Language/zh_CN miniProgram/wx9f2d7ce09eafe921',
    'Referer': 'https://gwxg.xsyu.edu.cn/h5/mobile/sign/index/monitor/statistics',
    'Connection': 'keep-alive',
    'JWSESSION': JWSESSION,
    'Cookie': `JWSESSION=${JWSESSION}; JWSESSION=${JWSESSION}`,
    'Sec-Fetch-Dest': 'empty',
